...
pub fn state_dir() -> PathBuf {
    ...
    home.join("Library/Application Support/com.chipcolate.spank")
}
...
impl From<spank_dsp::Detection> for Slap {
    fn from(d: spank_dsp::Detection) -> Self {
        Slap {
            t: d.t,
            tier: d.tier,
            peak_g: d.peak_g,
