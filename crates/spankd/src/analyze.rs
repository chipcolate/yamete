//! `spankd analyze` — report the signal distribution in a fixture.
//!
...
use spank_dsp::{Config, Detector, Frame};
...
fn traces(fixture: &spank_dsp::Fixture, cfg: Config) -> Traces {
...
pub fn at_detections(files: &[PathBuf]) -> Result<(), Error> {
    ...
    let mut rows: Vec<(String, spank_dsp::Scores, f32)> = Vec::new();
